...
function CadastroProdutos() {
  ...
  function salvarProduto(dadosFormularioProduto: Produto) {
    ...
    let configuracao: AxiosRequestConfig =
      editandoProduto === true ? configuracaoUpdate : configuracaoInsert;
  ...
  return (
    <div className="cadastro-produto-form-container">
      <div className="cadastro-produto-form-card">
        <div className="cadastro-produto-form-titulo">Dados do Produto</div>
        <form onSubmit={handleSubmit(salvarProduto)}>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Select
                      ...
                      getOptionLabel={(categoria: Categoria) =>
                        categoria.descricao
                      }
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Select
                      ...
                      getOptionLabel={(embalagem: Embalagem) =>
                        embalagem.descricao
                      }
                      getOptionValue={(embalagem: Embalagem) =>
                        String(embalagem.id)
                      }
                    />
                  )}
          ...
          <div className="cadatro-produto-form-botoes-container">
            <button
              className="btn btn-outline-danger botao-cancelar"
